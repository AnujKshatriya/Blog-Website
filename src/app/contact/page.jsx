...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "ef1cc47d-ddab-4d98-b1f1-567bc55bba93");
  ...
  return (
    ...
    <div className={styles['contact-section']}>
      <div className={styles['contact-left']}>
        ...
        <div className={styles['contact-details']}>
          <div className={styles['contact-detail']}>
            ...
            <p>anujkshatriyaiitian@gmail.com</p>
          </div>
          <div className={styles['contact-detail']}>
          ...
          <div className={styles['contact-detail']}>
            <svg className={styles.icon} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"/></svg>
            <p>Dahod/Gujarat</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={onSubmit} className={styles['contact-right']}>
        ...
        <button type='submit' className={styles['contact-submit']}>Submit Now</button>
      </form>
    </div>
